Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/HackingGate/twitter-kit-ios"
  s.documentation_url = "https://github.com/HackingGate/twitter-kit-ios/wiki"
  s.social_media_url = "https://twitter.com/TwitterDev"
  s.authors = "Twitter"
  s.platform = :ios, "9.0"
  s.source = { :http => "https://github.com/HackingGate/twitter-kit-ios/releases/download/#{s.version}/TwitterKit.zip" }
